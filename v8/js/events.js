...
// Render Event Detail View - Updated with new features
function renderEventDetailView(event) {
    ...
    if (!isPastEvent) {
        ...
        addItemBtn.className = `floating-btn ${userHasRsvpd ? 'disabled' : ''}`;
        addItemBtn.innerHTML = `
            <i class="fas fa-plus-circle"></i>
            <span>RSVP</span>
        `;
        
        // If user has already RSVP'd, disable the button
        if (userHasRsvpd) {
...
// Event Modal Functions - Updated with public checkbox
