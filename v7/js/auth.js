        ...
        mainContent.innerHTML = `
            <div class="login-container">
                <div class="login-logo">
                    <img src="assets/logo.png" alt="Event Planner" class="logo-img">
                </div>
                <h2 class="login-title">Welcome to Event Planner</h2>
                <p class="login-text">Please sign in to create or join events</p>
