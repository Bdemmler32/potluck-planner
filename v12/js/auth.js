...
// Render login view if not authenticated - Updated for better centering and Google icon
                ...
                <div class="login-content-wrapper">
                    ...
                    <button id="login-google-btn">
                        <div class="google-icon-wrapper">
                            <img class="google-icon" src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" alt="Google G Logo">
                        </div>
                        Sign in with Google
                    </button>
                </div>
